...
config = DelightfulTTSConfig(
    ...
    phoneme_cache_path="tests_all/data/ljspeech/phoneme_cache/",
    f0_cache_path="tests_all/data/ljspeech/f0_cache_delightful/",  ## delightful f0 cache is incompatible with other models
    epochs=1,
    print_step=1,
    print_eval=True,
    ...
    d_vector_file="tests_all/data/ljspeech/speakers.json",
    d_vector_dim=256,
...
config.model_args.d_vector_file = "tests_all/data/ljspeech/speakers.json"
...
command_train = (
    ...
    "--coqpit.datasets.0.path tests_all/data/ljspeech "
    "--coqpit.datasets.0.meta_file_attn_mask tests_all/data/ljspeech/metadata_attn_mask.txt "
...
shutil.rmtree("tests_all/data/ljspeech/f0_cache_delightful/")
